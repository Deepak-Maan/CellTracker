...
const Newsletter = () => {
  return (
    <div className="pt-16 relative mt-14 px-3 md:px-6 lg:px-0">
        ...
        <div className="bg-newsBg lg:max-h-[391px]  rounded-xl bg-center  bg-no-repeat  bg-cover">
          <div className="flex flex-row flex-wrap lg:max-h-[391px] ">
            <div className="lg:w-6/12 w-full">
              <img
                className="w-[332px] sm:w-[529px] translate-y-[-25%] md:translate-y-[-15%] h-[376px] sm:h-[600px] "
                src={PhoneNews}
                alt="newsletter_Phone"
              />
            </div>
            <div className="lg:w-6/12 w-full lg:pt-14 mt-[-100px] lg:mt-0">
              <div className=" flex  flex-col justify-center pb-12 lg:pb-0 items-center">
