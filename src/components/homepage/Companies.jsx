  ...
  return (
    ...
    >
      <img
        src={toplayer}
        alt="toplayer"
        className="absolute -top-1 pointer-events-none xl:top-[-10%] 2xl:top-[-11%] w-full"
      />
      <img
        src={btmlayer}
        alt="botmlayer"
        className="absolute -bottom-1 pointer-events-none md:bottom-[-3%] lg:bottom-[-8%] xl:bottom-[-12%] 2xl:bottom-[-15%] w-full"
      />
          ...
          {joinCompanies.map((obj, id) => {
            return (
              <div
                data-aos="zoom-in"
                key={id}
                className={`pl-9 md:-ms-3 bg-white  rounded-tl-xl sm:rounded-tr-xl rounded-br-xl border-y border-s border-solid max-lg:max-w-[500px] w-full h-full relative max-sm:px-6 shadow-[0px_16px_25.3px_0px_#00000014] ${
                  id === 1
              ...
              >
                ...
                <div className="flex sm:flex-row sm:gap-3 md:gap-4  flex-col items-center max-sm:w-full">
                  ...
                  {id === 1 && (
                    <p className="font-normal mt-2 lg:mt-0 text-sm md:text-base gap-3   text-darkGray leading-normal">
